...
이제는 단순한 개념적 학습이 아닌 실무에서 방대한 데이터 처리를 실시간으로 처리해야 하는 상황에 직면한 것이다. 참고로 국산 시계열 데이터베이스인 마크베이스([MACHBASE](https://www.machbase.com/))를 살펴볼 필요가 있는데 [초당 104만 건 정도의 데이터를 처리](https://www.mk.co.kr/news/business/view/2020/01/90596/)할 수 있다고 한다.
