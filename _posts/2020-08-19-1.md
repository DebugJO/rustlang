...
소스 예제는 'Thumb IKR - Programming Examples'의 [유튜브 강좌](https://www.youtube.com/watch?v=l0vPG0zLTWU)를 참고하였고 일부 소스는 수정하였다. VS2019에서 **ASP.NET Core 웹 애플리케이션**(MVC) 프로젝트를 생성하고 기본값을 그대로 사용하였으며 변경된 부분의 코드 위주로 아래에 소소를 나열하였다.

추가한 nuget package는 *RepoDb.SqlServer*와 *RepoDb.SqlServer.BulkOperations*이다[(repodb.net).](https://repodb.net/)
