...
Rust 언어에 기반한 web framework로는 [Actix](https://actix.rs/), [Rocket](https://rocket.rs/), [Gotham](https://gotham.rs/) 등이 있다. 이 중에서 최근에 많이 사용하는 Actix를 이용하여 basic 인증을 포함한 간단한 WebAPI 예제를 구현해보았다. 
