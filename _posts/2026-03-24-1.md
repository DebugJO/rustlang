...
이전 글 [C# AOT 라이브러리 활용](https://rustlang.kr/2026/03/22/1/)에 이어 이번 글에서는 로그 시스템으로 많이 사용하는 [NLog](https://github.com/NLog/NLog)를 AOT(Ahead-of-Time)로 빌드하여 라이브러리로 사용하는 법을 알아본다. 
