...
[Intro to MongoDB with C#](https://devsight.kr/2020/04/12/1/)에 이어 이번 주제는 MongoDB와 함께 ASP.NET Core 6 REST API<sup>1</sup>를 구현하는 예제(Sample)이다.

이전과 마찬가지로 Nuget에서 [MongoDB.Driver](https://www.nuget.org/packages/MongoDB.Driver) 패키지를 추가한다.
...
> Reference
> 1. [kudvenkat, "ASP.NET Core 6 REST API Tutorial, MongoDB Database"](https://www.youtube.com/watch?v=iWTdJ1IYGtg)
