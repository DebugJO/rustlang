...
컴파일러가 C\+\+11을 완전히 지원하는 경우 싱글톤을 구현하는 가장 좋은 방법은 'Magic Static'을 사용하는 것이다<sup>1</sup>. C\+\+11부터는 static 객체 생성이 스레드에 안전하게 보장하도록 표준에 추가되었다<sup>2</sup>.
...
* 참고한 소스 : [VoidRealms, Magic Statics - Singleton Replacement - Qt 5 Design Patterns](https://www.youtube.com/watch?v=q050zO-fpq0)
